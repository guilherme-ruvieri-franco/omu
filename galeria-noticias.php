...
<body>
  <header class="cabecalho">
    <a class="link-logo-omu"><img class="logo-omu" src="elementos_visuais\logos\logo-omu-completo.png"
        alt="Logo da OMU"></a>
...
<?php
  ...
  ?>
        <a href="<?php echo htmlspecialchars($urlNoticia); ?>" class="polaroid-manchete">
          <img class="foto-polaroid"
               src="<?php echo htmlspecialchars($srcImagem); ?>"
               alt="<?php echo htmlspecialchars($manchete); ?>">
          <div class="manchete">
            <?php echo htmlspecialchars($manchete); ?>
          </div>
        </a>
  <?php
